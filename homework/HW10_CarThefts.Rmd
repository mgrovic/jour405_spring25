...
There seems to be a decrease in car thefts over the last two years, however it was not a consistent trend (not linear)
```{r}
...
Not necessarily. Although the mean is about 460, I still think that there is a decrease overall but it was not consistent. 
...
The range that we are 95% confident that the overall average number of car thefts for the entire population falls

The mean (460.4) most accurately reflects the normal car thefts in a typical month

Headline: Monthly Car Thefts in Prince George's County dip below average for the second time in the last three years. 
...
The difference between the two periods is not statistically significant, as the p-value is 0.1791 which is much larger than 0.05, so there for we cannot reject the null. 
...
I honestly wouldn't change up my headline from before. I would tell my editor that it is important to mention the history of the trend, how it is dropping now, but also how it dropped before. 
