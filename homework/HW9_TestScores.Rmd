...
# View the data
score_data
mean_score <- sum(new_scores) / length(new_scores)
mean_score
```
...
The test score have improved, as the original score was 72.6, and was raised to 75.75. This increase shows an increase in test scores. 
...
Looking at the mean and standard deviation of the new scores compared to the previous statistics, what initial observations can you make? What questions might these statistics raise for your reporting?
 variability in reading scores has decreased, meaning that some of the classrooms performed much closer to each others. The results were more consistent across classrooms.
...
Impact of New Reading Program on Test Scores
...
The small p-value shows strong evidence that the new reading program significantly improved test scores, making it unlikely that the observed improvement occurred by chance. The average score increased from 72.6 to 75.75, indicating a real positive effect from the program.
...
New Reading Program Leads to 4.3% Increase in Test Scores
After implementing a new reading program, third-grade students' average test scores rose from 72.6 to 75.75, marking a 4.3% improvement. The results, backed by a highly significant p-value strongly support the superintendent's claim that the program has positively impacted reading performance.


### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?

Besides test scores, it's important to look at how well students understand what they read and how interested they are in reading. Teachers’ feedback and how students act in class can also help show if the program is working.
