...
ANSWER HERE
A couple things stand out to me when looking at my findings. The median and mean are quite similar, with only a 3k difference between them, displaying that there are either no outliers significantly skewing the data, or that there are outliers on both ends, evening the data out. The minimum salary being 0 originally struck me as odd, a possible mistake, but after examining the original data set, it seems that there are numerous people not receiving official compensation for their work. 
...
ANSWER HERE
Story Idea: What role do unpaid employees play in the daily operations of the White House ?

My next steps would include identifying the positions of those whose salaries are listed as 0, attempting to identify any trends. I would also do background research to try and see if former employees with the same title were compensated, and finally I would reach out asking if this was correct, and if it is get their statements/perspective. 
