...
Community Colleges have the lowest mean and median SAT scores by a significant margin, however also has the largest SD by a large margin. Although this means that on average, a community college student may have a lower SAT score than a public or private school student, there is the most variance in a community college students scores. 
...
Yes there are major differences in SAT scores across college types

2. Which specific college types differ from each other?

All three colleges differ significantly 

3. How large are these differences?

Very very large between community college and private and public institutions. Private and public schools are closer, but the gap is still largest enough to be statistically significant. 
...
Private Colleges Top SAT Rankings in Wide Score Disparities

Students enrolled at private universities consistently outperform their peers on the SAT, highlighting stark test score differences across school types. However are these vastly different test score based on academic excellence? or is there something more to this disparity in scores. 
