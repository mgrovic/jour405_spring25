...
I think it is just a bit more uniform than I would expect. Movie raitings are not something that everyone agrees with, or there is a popular opinion on every moive. I would've expected a lot more 2 and 3 stars. 
...
Since the chi-square statistic (9.9521) is greater than the critical value (9.487729), we reject the null hypothesis. This means that there is a statistically significant difference between the observed frequencies of movie ratings and the expected frequencies.
