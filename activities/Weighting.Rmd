...
These differences can affect reporting on likely voter turnout by shifting the perceived level of support for different options. If certain groups, like "rarely/never" voters, have their responses adjusted upward, it suggests they were underrepresented in the initial sample. This means that early polling results might have painted a different picture than the weighted data, which better reflects actual voter behavior.
...
These differences likely exist because some groups are more or less likely to respond to surveys, causing imbalances in the initial data. Weighting the data helps correct for biases by adjusting the data to match the real population. This suggests that groups like "rarely/never" voters may have been underrepresented in the unweighted sample, while more frequent voters may have been overrepresented. 
