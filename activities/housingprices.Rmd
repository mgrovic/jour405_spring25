...
Home prices have climbed 6.8% near the new transit line, giving some weight to officials' claims that the project is driving up property values. But while the data suggests a connection, other factors—like broader market trends and local development—could also be influencing the rise. Isolating the impact of transit alone is difficult, as home prices are shaped by multiple economic and policy forces.
