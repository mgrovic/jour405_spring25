...
```{r}
sample_100 |> 
  summarise(mean_sample = mean(age), sd_sample = sd(age))
```
...
My 100 sample and my populations are quite similar. When I go back and re ran the data, with a 50 and 10 sample size, my data did not change much. I know that this was just luck of the sample, as most people's mean and sd changed a lot, but mine basiclly stayed the same the whole time. Normally though, the smaller the sample size, the less representitive the data is. 
